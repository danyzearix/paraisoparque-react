...
useEffect(() => {
  ...
  axios.get('http://localhost:3000/datos')
    .then(response => {
      ...
      console.log(data)// Actualizar el estado con los datos de la API
    })
    .catch(error => {
  ...
  return (
    ...
    <div className='ObituariosContainer'>
      ...
      <div className="container-hijo izquierdaObi">
                <img className='ObiImage' src="https://elparaisoparquecementerio.com.co/wp-content/uploads/2023/06/Obituarios.jpg" width={210} height={210} alt="" />
              </div>
        <div className="grid">
