  ...
  return (
    ...
    <div className="productos-content">
      ...
      <div className="productos-content">
        ...
        <div className="image-section">
        <img src="https://www.memorialjardines.com/wp-content/uploads/2016/11/LOTES.png" alt="Imagen de producto" className="product-image" />
        </div>
      </div>
...
LOTE INTEGRAL: En propiedad a perpetuidad doble o triple e incluye servicio de inhumación y derecho de cementerio para los dos o tres espacios de el lote.</p>
        ...
        <div className="image-section">
        <img src="https://elparaisoparquecementerio.com.co/wp-content/uploads/2023/03/Diseno-sin-titulo-4-600x400.jpg" alt="Imagen de producto" className="product-image" />
        </div>
      </div>
